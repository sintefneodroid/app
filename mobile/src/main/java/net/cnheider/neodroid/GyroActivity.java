...
ready =true;
  ...
  public void onSensorChanged(SensorEvent sensorEvent) {
    ...
    if (sensorEvent.sensor.getType() == Sensor.TYPE_ROTATION_VECTOR) {
      ...
      SensorManager.getOrientation(_rotation_matrix, mOr);

      imageView_gyro.setTranslationX(mOr[2] * 100);
      imageView_gyro.setTranslationY(-mOr[1] * 100);
      imageView_gyro.setTranslationZ(mOr[0] * 100);
