...
public final class FBody extends Struct {
  ...
  public FBody __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public FVector3 velocity() {
    return velocity(new FVector3());
  }

  public FVector3 velocity(FVector3 obj) {
    return obj.__assign(bb_pos + 0, bb);
  }

  public FVector3 angularVelocity() {
    return angularVelocity(new FVector3());
  }

  public FVector3 angularVelocity(FVector3 obj) {
