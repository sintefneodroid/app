...
public final class FMotor extends Table {
  public static FMotor getRootAsFMotor(ByteBuffer _bb) {
    return getRootAsFMotor(_bb, new FMotor());
  }
  ...
  public FMotor __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static void startFMotor(FlatBufferBuilder builder) {
    builder.startObject(3);
  }

  public static void addMotorName(FlatBufferBuilder builder, int motorNameOffset) {
    builder.addOffset(0, motorNameOffset, 0);
  }

  public static void addValidInput(FlatBufferBuilder builder, int validInputOffset) {
    builder.addStruct(1, validInputOffset, 0);
  }
  ...
  public Neodroid.FBS.FRange validInput() {
    return validInput(new Neodroid.FBS.FRange());
  }

  public Neodroid.FBS.FRange validInput(Neodroid.FBS.FRange obj) {
    int o = __offset(6);
