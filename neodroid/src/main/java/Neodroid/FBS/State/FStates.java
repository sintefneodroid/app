...
public final class FStates extends Table {
  public static FStates getRootAsFStates(ByteBuffer _bb) {
    return getRootAsFStates(_bb, new FStates());
  }
  ...
  public FStates __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static boolean FStatesBufferHasIdentifier(ByteBuffer _bb) {
    return __has_identifier(_bb, "XSTA");
  }

  public static void startFStates(FlatBufferBuilder builder) {
    builder.startObject(3);
  }

  public static void addStates(FlatBufferBuilder builder, int statesOffset) {
    builder.addOffset(0, statesOffset, 0);
  }

  public static int createStatesVector(FlatBufferBuilder builder, int[] data) {
  ...
  public static void startStatesVector(FlatBufferBuilder builder, int numElems) {
  ...
  public static void finishFStatesBuffer(FlatBufferBuilder builder, int offset) {
    builder.finish(offset, "XSTA");
  }

  public FState states(int j) {
    return states(new FState(), j);
  }

  public FState states(FState obj, int j) {
    int o = __offset(4);
  ...
  public FState statesByKey(String key) {
    int o = __offset(4);
    return o != 0 ? FState.__lookup_by_key(__vector(o), key, bb) : null;
  }
