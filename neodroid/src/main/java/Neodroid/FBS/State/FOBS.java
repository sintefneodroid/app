...
public final class FOBS extends Table {
  public static FOBS getRootAsFOBS(ByteBuffer _bb) {
    return getRootAsFOBS(_bb, new FOBS());
  }
  ...
  public FOBS __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static int createFOBS(FlatBufferBuilder builder, int observation_nameOffset, byte observation_type, int observationOffset) {
  ...
  public static void addObservationName(FlatBufferBuilder builder, int observationNameOffset) {
    builder.addOffset(0, observationNameOffset, 0);
  }
  ...
  public static void startFOBS(FlatBufferBuilder builder) {
    builder.startObject(3);
  }
  ...
  public ByteBuffer observationNameAsByteBuffer() {
