...
public final class FReactionParameters extends Struct {
  ...
  public FReactionParameters __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public boolean step() {
    return 0 != bb.get(bb_pos + 1);
  }

  public boolean reset() {
    return 0 != bb.get(bb_pos + 2);
  }

  public boolean configure() {
    return 0 != bb.get(bb_pos + 3);
  }

  public boolean describe() {
    return 0 != bb.get(bb_pos + 4);
  }

  public boolean episodeCount() {
    return 0 != bb.get(bb_pos + 5);
  }
}
