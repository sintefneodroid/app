...
public class MyPose {
  ...
  public MyPose(float[] sixDoFSensorValues, long timestamp){
  ...
  public MyPose(float[] translation, float[] rotation, long timestamp){
    mTimestamp = timestamp;
  ...
  public String toString() {
    return Arrays.toString(mTranslation) + ", " + Arrays.toString(mRotation);
  }
}
